...
// Load 'tds_api.php' and initialize multipurpose plugin only for 'Newspaper' theme
$current_theme = wp_get_theme();

if ( '011' === $current_theme->stylesheet || 'Newspaper' === $current_theme->stylesheet || 'Newspaper-child' === $current_theme->stylesheet ) {
	require_once( 'styles/tds_api.php' );

	// Instantiate td_api_multi_purpose class (the entry point)
...
class td_api_multi_purpose {
	...
	static $typography_settings_list;
 	...
 	function __construct() {
		...
		$this->set_group_params();

		add_action( 'td_wp_booster_loaded', array($this, 'tdm_on_load_images' ), 10001 ); // hook used to load default images
		add_action( 'td_wp_booster_loaded', array($this, 'tdm_on_register_shortcodes' ), 10001 ); // hook used to add or modify items via Api

        //add_action( 'td_wp_booster_loaded', array($this, 'tdm_on_td_wp_booster_loaded' ), 10003 ); // hook used to add the blocks widgets
		...
		add_action( 'admin_head', array('td_api_multi_purpose', 'tdm_on_admin_head' ), 11 ); // 11 to be after 'admin_head' hook of tagDiv composer
		...
		add_action('td_global_after', array( 'td_api_multi_purpose', 'hook_td_global_after' ));

    }

	function set_group_params() {
		if ( empty( $this->group_params ) ) {
			$this->group_params = array(
                ...
                'button' => array(
                    ...
                    array(
                        ...
                        "type" => "dropdown",
                        "value" => tds_api::get_styles_for_mapping( 'tds_button' ),
                        "heading" => 'Button style',
                        "description" => "",
                        "holder" => "div",
                        "class" => "tdc-dropdown-big",
                ...
                'social_icons' => array(
                    ...
                    array(
                        ...
                        "type" => "dropdown",
                        "value" => tds_api::get_styles_for_mapping('tds_social', false),
                        "heading" => 'Social style',
                        "description" => "",
                        "holder" => "div",
                        "class" => "tdc-dropdown-big",
...
//		);
	...
	static function tdm_on_admin_head() {
		ob_start();
	?>
		<script>
			window.tdcAdminSettings.settingsStyle = {};
			window.tdcAdminSettings.globalStyle = {};
		...
		foreach ( tds_api::get_all() as $style_id => $style ) {
			...
			if ( ! in_array( $group_style, $groups ) ) {
				...
				?>
				<script>
					window.tdcAdminSettings.settingsStyle.<?php echo $group_style ?> = <?php echo json_encode( tds_api::get_styles_by_group( $group_style ) ) ?>;
					window.tdcAdminSettings.globalStyle.<?php echo $group_style ?> = <?php echo json_encode( td_options::get( $group_style, $style_id ) ) ?>;
				</script>
				<?php
			}
		}
    ...
    static function hook_td_global_after()  {
        /**
                    ...
                    json_encode(
                        array(
                            array(
                                ...
                                'button_icon' => 'tdc-font-fa tdc-font-fa-chevron-right',
	                ...
	                array_merge(
                        ...
                        array(
                            ...
                            array(
                                ...
                                "type" => "dropdown",
                                "value" => tds_api::get_styles_for_mapping( 'tds_title', false ),
                                "heading" => 'Title style',
                                "description" => "",
                                "holder" => "div",
                                "class" => "tdc-dropdown-big",
                    ...
                    json_encode(
                        array(
                            array(
                                ...
                                'button_icon-1' => 'tdc-font-fa tdc-font-fa-search',
                                'button_url-1' => '#',
                                'tds_button-1' => 'tds_button3',
                                'button_size-1' => 'tdm-btn-lg',
                                'block_width' => 'tdm-width-1200',
                                'content_align_horizontal' => 'content-horiz-center',
                                'content_align_vertical' => 'content-vert-center',
                                'background_color_a' => 'rgba(0,0,0,0.85)',
                                'background_color_b' => 'rgba(22,112,191,0.85)',
                            )
                        )
                    )
                ),
                "params" => array_merge(
                    ...
                    array(
                        ...
                        array(
                            ...
                            "type" => "dropdown",
                            "value" => array(
                                '1068px - Main grid width' => 'tdm-width-1068',
                                '1200px' => 'tdm-width-1200',
                                '1400px' => 'tdm-width-1400',
                                '1600px' => 'tdm-width-1600',
                                '1800px' => 'tdm-width-1800',
                                'Full width' => 'tdm-width-full',
                            ),
                    ...
                    json_encode(
                        array(
                            array(
                                ...
                                'button_icon_size' => '18',
                                'button_url' => '#',
                                'button_icon' => 'tdc-font-fa tdc-font-fa-graduation-cap',
                            )
                        )
                    )
                ),
                ...
                'tdc_start_values' => base64_encode(
                    json_encode(
                        array(
                            ...
                            array(
                                'tdc_preset_name' => 'First Set',
                                'tds_title' => 'tds_title1',
                                'title_text' => base64_encode( 'Style 1' ),
                                'title_size' => 'tdm-title-md',
                            ),
                            array(
                                'tdc_preset_name' => 'Style 2',
                                'tds_title' => 'tds_title2',
                                'title_text' => base64_encode( 'Style 2' ),
                                'title_size' => 'tdm-title-md',
                                'tds_title2-title_color' => '#8224e3',
                                'tds_title2-line_height' => '10',
                            )
                        )
                    )
                ),
                ...
                "params" => array_merge(
                    array(
                        ...
                        array(
                            ...
                            "type" => "dropdown",
                            "value" => tds_api::get_styles_for_mapping('tds_team_member', false ),
                            "heading" => 'Style',
                            "description" => "",
                            "holder" => "div",
                            "class" => "tdc-dropdown-big",
                    ...
                    json_encode(
                        array(
                            ...
                            array(
                                ...
                                "image_size" => "60",
                                "tdc_css" => "",
                ...
                "params" => array_merge(
                    array(
                        ...
                        array(
                            ...
                            "type" => "dropdown",
                            "value" => tds_api::get_styles_for_mapping('tds_testimonial', false ),
                            "heading" => 'Style',
                            "description" => "",
                            "holder" => "div",
...
//                ),
                ...
                "params" => array_merge(
                    ...
                    array(
                        ...
                        array(
                            ...
                            "type" => "dropdown",
                            "value" => tds_api::get_styles_for_mapping( 'tds_call_to_action', false ),
                            "heading" => 'Style',
                            "description" => "",
                            "holder" => "div",
                            "class" => "tdc-dropdown-extrabig",
                    ...
                    json_encode(
                        array(
                            array(
                                ...
                                'features_icon' => 'tdc-font-fa tdc-font-fa-check',
                                'features_non_icon' => 'tdc-font-fa tdc-font-fa-remove-close-times',
                                'button_text'  => 'Purchase',
                                'button_icon'  => 'tdc-font-fa tdc-font-fa-shopping-cart',
                                'button_size'  => 'tdm-btn-md',
                                'content_align_horizontal' => 'content-horiz-center',
                            ),
                            array(
                                ...
                                "title_text" => "QU5EUk9JRCUyMFN0YW5kYXJk",
                                "title_size" => "tdm-title-sm",
                                "currency" => "",
                                "features" => "",
                                "features_icon" => "tdc-font-fa tdc-font-fa-check",
                                "features_non_icon" => "tdc-font-fa tdc-font-fa-remove-close-times",
                                "button_icon" => "tdc-font-tdmp tdc-font-tdmp-parcel",
                                "button_size" => "tdm-btn-lg",
                                "content_align_horizontal" => "content-horiz-center",
                ...
                "params" => array_merge(
                    ...
                    array(
                        ...
                        array(
                            ...
                            "type" => "dropdown",
                            "value" => tds_api::get_styles_for_mapping( 'tds_pricing', false ),
                    ...
                    json_encode(
	                    array(
	                        array(
		                        ...
		                        'icon' => 'tdc-font-fa tdc-font-fa-star',
		                        'content_align_horizontal' => 'content-horiz-left',
	                        ),
	                    )
                    )
            ...
            array(
                ...
                'tdc_start_values' => base64_encode(
                    json_encode(
                        array(
                            array(
                                'icon_id' => 'tdc-font-fa tdc-font-fa-star-o',
                                'icon_size' => '50',
                            ),
                            array(
                            ...
                            array(
                                ...
                                "icon_id" => "tdc-font-fa tdc-font-fa-connectdevelop",
                                "icon_size" => "40",
                                "tds_icon1-color" => "#ffffff",
                ...
                "params" => array_merge(
                    array(
                        ...
                        array(
                            "param_name" => "tds_icon",
                            "type" => "dropdown",
                            "value" => tds_api::get_styles_for_mapping( 'tds_icon', false ),
                            "heading" => 'Style',
                            "description" => "",
                            "holder" => "div",
                            "class" => "tdc-dropdown-big",
            ...
            array(
                ...
                'tdc_start_values' => base64_encode(
                    json_encode(
                        array(
                            array(
                                "icon_id" => "tdc-font-tdmp tdc-font-tdmp-bulb-idea",
                                'icon_size' => '80',
                                'icon_padding' => '1',
                                ...
                                'button_size'  => 'tdm-btn-md',
                                'button_icon'  => 'tdc-font-fa tdc-font-fa-long-arrow-right',
                                'tds_button' => 'tds_button3',
                                'content_align_horizontal' => 'content-horiz-center',
                            ),
                            array(
                                ...
                                "tds_icon1-shadow_color" => "rgba(33,185,209,0.1)",
                            ...
                            array(
                                ...
                                "tds_icon1-shadow_offset_vertical" => "3",
                                "tds_icon1-shadow_size" => "14",
                                "tds_icon1-border_radius" => "50",
                                "tds_icon1-hover_border_radius" => "50",
                                "tds_icon1-shadow_color" => "rgba(10,10,10,0.06)",
                            ...
                            array(
                                ...
                                "tds_icon1-hover_shadow_size" => "10",
                                "tds_icon1-hover_shadow_offset_vertical" => "3",
                                "tds_icon1-hover_shadow_color" => "rgba(0,0,0,0.1)",
                                "tds_button" => "tds_button1",
                ...
                "params" => array_merge(
                    array(
                        ...
                        array(
                            ...
                            "type" => "dropdown",
                            "value" => tds_api::get_styles_for_mapping( 'tds_icon_box', false ),
                            "heading" => 'Style',
                            "description" => "",
                            "holder" => "div",
                            "class" => "tdc-dropdown-big",
                ...
                "params" => array_merge(
                    array(
                        ...
                        array(
                            ...
                            "type" => "dropdown",
                            "value" => tds_api::get_styles_for_mapping('tds_progress_bar', false ),
                            "heading" => 'Style',
                            "description" => "",
                            "holder" => "div",
                            "class" => "tdc-dropdown-extrabig",
                ...
                "params" => array_merge(
                    array(
                        ...
                        array(
                            ...
                            "type" => "dropdown",
                            "value" => tds_api::get_styles_for_mapping('tds_counter', false ),
                            "heading" => 'Style',
                            "description" => "",
                            "holder" => "div",
                            "class" => "tdc-dropdown-extrabig",
                ...
                "params" => array_merge(
                    array(
                        ...
                        array(
                            ...
                            "type" => "dropdown",
                            "value" => tds_api::get_styles_for_mapping( 'tds_food_menu', false ),
                ...
                "params" => array_merge(
                    ...
                    array(
                        ...
                        array(
                            ...
                            "type" => "dropdown",
                            "value" => tds_api::get_styles_for_mapping( 'tds_title_over_image', false ),
    ...
    function tdm_on_td_wp_booster_loaded() {
	...
	function register_styles() {
        ...
        tds_api::add( 'tds_social2', array(
                'group' => 'tds_social',
                'title' => 'Style 2 - Simple',
        ...
        tds_api::add( 'tds_social5', array(
                ...
                'params' => array(
                    ...
                    array(
                        ...
                        "class" => "",
                        "heading" => 'Color',
                        "param_name" => "social_shadow_color",
                        "value" => '',
                        "description" => '',
                        "group" => "Style",
                    ),
                    array(
                        'param_name' => 'social_shadow_offset_horizontal',
                        'type' => 'range',
                        'value' => '0',
                        'heading' => 'Offset H',
                        'description' => '',
                    ...
                    array(
                        'param_name' => 'social_shadow_offset_vertical',
                        'type' => 'range',
                        'value' => '2',
                        'heading' => 'Offset V',
                        'description' => '',
                    ...
                    array(
                        'param_name' => 'social_shadow_hover_size',
                        'type' => 'textfield',
                        'value' => '',
                        'heading' => 'Hover size',
                        'description' => '',
                    ...
                    array(
                        ...
                        "class" => "",
                        "heading" => 'Hover color',
                        "param_name" => "social_shadow_hover_color",
                        "value" => '',
                        "description" => '',
                        "group" => "Style",
                    ),
                    array(
                        'param_name' => 'social_shadow_hover_offset_horizontal',
                        'type' => 'range',
                        'value' => '0',
                        'heading' => 'Hover offset H',
                        'description' => '',
                        'class' => 'tdc-textfield-small',
                        'range_min' => '-40',
                        'range_max' => '40',
                    ...
                    array(
                        'param_name' => 'social_shadow_hover_offset_vertical',
                        'type' => 'range',
                        'value' => '2',
                        'heading' => 'Hover offset V',
                        'description' => '',
                        'class' => 'tdc-textfield-small',
                        'range_min' => '-40',
                        'range_max' => '40',
        ...
        // Team member style
        tds_api::add( 'tds_team_member1', array(
        ...
        tds_api::add( 'tds_team_member2', array(
                'group' => 'tds_team_member',
        ...
        tds_api::add( 'tds_team_member3', array(
                'group' => 'tds_team_member',
        ...
        // Progress bar style
        tds_api::add( 'tds_progress_bar1', array(
        ...
        tds_api::add( 'tds_progress_bar2', array(
                'group' => 'tds_progress_bar',
        ...
        tds_api::add( 'tds_progress_bar3', array(
                'group' => 'tds_progress_bar',
                ...
                'params' => array(
                    ...
                    array(
                        'param_name' => 'percentage_bar_width',
                        'type' => 'textfield',
                        'value' => '',
                        'heading' => 'Percentage bar width',
                        'description' => '',
                        'class' => 'tdc-textfield-small',
                        'placeholder' => '',
                    ),
        ...
        // Counter style
        tds_api::add( 'tds_counter1', array(
                'group' => 'tds_counter',
                'title' => 'Style 1 - Simple',
        ...
        // Pricing style
        tds_api::add( 'tds_pricing1', array(
                'group' => 'tds_pricing',
                'title' => 'Style 1 - Default',
        ...
        tds_api::add( 'tds_pricing2', array(
                'group' => 'tds_pricing',
        ...
        tds_api::add( 'tds_pricing3', array(
                'group' => 'tds_pricing',
        ...
        // Food menu style
        tds_api::add( 'tds_food_menu1', array(
                'group' => 'tds_food_menu',
                'title' => 'Style 1 - Default',
        ...
        tds_api::add( 'tds_call_to_action1', array(
        ...
        tds_api::add( 'tds_call_to_action2', array(
                'group' => 'tds_call_to_action',
        ...
        // Testimonial style
        tds_api::add( 'tds_testimonial1', array(
        ...
        tds_api::add( 'tds_testimonial2', array(
                'group' => 'tds_testimonial',
        ...
        tds_api::add( 'tds_testimonial3', array(
                'group' => 'tds_testimonial',
                'title' => 'Style 3 - With background',
        ...
        tds_api::add( 'tds_button3', array(
                ...
                'params' => array(
                    ...
                    array(
                        'param_name' => 'shadow_hover_size',
                        'type' => 'textfield',
                        'value' => '',
                        'heading' => 'Hover shadow size',
                        'description' => '',
                        'class' => 'tdc-textfield-small',
                        'placeholder' => '26',
                        "group" => "Style",
                    ...
                    array(
                        'param_name' => 'shadow_hover_offset_horizontal',
                        'type' => 'range',
                        'value' => '0',
                        'heading' => 'Hover offset H',
                        'description' => '',
                    ...
                    array(
                        'param_name' => 'shadow_hover_offset_vertical',
                        'type' => 'range',
                        'value' => '2',
                        'heading' => 'Hover offset V',
                        'description' => '',
        ...
        tds_api::add( 'tds_icon1', array(
                ...
                'params' => array(
                    ...
                    array(
                        'param_name' => 'hover_shadow_offset_horizontal',
                        'type' => 'range',
                        'value' => '0',
                        'heading' => 'Hover offset H',
                        'description' => '',
                    ...
                    array(
                        'param_name' => 'hover_shadow_offset_vertical',
                        'type' => 'range',
                        'value' => '0',
                        'heading' => 'Hover offset V',
                        'description' => '',
        ...
        //icon box
        tds_api::add( 'tds_icon_box1', array(
                'group' => 'tds_icon_box',
                'title' => 'Style 1 - Default',
        ...
        tds_api::add( 'tds_icon_box2', array(
                'group' => 'tds_icon_box',
        ...
        tds_api::add( 'tds_icon_box3', array(
                'group' => 'tds_icon_box',
                'title' => 'Style 3 - Under',
        ...
        tds_api::add( 'tds_icon_box4', array(
                'group' => 'tds_icon_box',
                ...
                'params' => array(
                    ...
                    array(
                        'param_name' => 'icon_box_shadow_size',
                        'type' => 'textfield',
                        'value' => '',
                        'heading' => 'Shadow size',
                        'description' => '',
                    ...
                    array(
                        ...
                        "class" => "",
                        "heading" => 'Shadow color',
                        "param_name" => "icon_box_shadow_color",
                        "value" => '',
                        "description" => '',
                        "group" => "Style",
                    ),
                    array(
                        'param_name' => 'icon_box_shadow_offset_horizontal',
                        'type' => 'range',
                        'value' => '0',
                        'heading' => 'Offset H',
                        'description' => '',
                    ...
                    array(
                        'param_name' => 'icon_box_shadow_offset_vertical',
                        'type' => 'range',
                        'value' => '0',
                        'heading' => 'Offset V',
                        'description' => '',
                    ...
                    array(
                        'param_name' => 'icon_box_shadow_hover_size',
                        'type' => 'textfield',
                        'value' => '',
                        'heading' => 'Hover shadow size',
                        'description' => '',
                    ...
                    array(
                        ...
                        "class" => "",
                        "heading" => 'Hover shadow color',
                        "param_name" => "icon_box_shadow_hover_color",
                        "value" => '',
                        "description" => '',
                        "group" => "Style",
                    ),
                    array(
                        'param_name' => 'icon_box_shadow_hover_offset_horizontal',
                        'type' => 'range',
                        'value' => '0',
                        'heading' => 'Hover offset H',
                        'description' => '',
                    ...
                    array(
                        'param_name' => 'icon_box_shadow_hover_offset_vertical',
                        'type' => 'range',
                        'value' => '0',
                        'heading' => 'Hover offset V',
                        'description' => '',
        ...
        tds_api::add( 'tds_icon_box5', array(
                'group' => 'tds_icon_box',
        ...
        tds_api::add( 'tds_title_over_image1', array(
