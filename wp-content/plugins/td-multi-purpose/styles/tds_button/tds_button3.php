...
class tds_button3 extends tds_api {
    ...
    private function get_css() {
        ...
        // style atts
        $td_css_compiler->load_setting_raw( 'text_color', $this->get_style_att( 'text_color' ));
        ...
        // background
        td_block::load_color_settings( $this, $td_css_compiler, 'background_color', 'background_solid', 'background_gradient' );

        // background hover
        td_block::load_color_settings( $this, $td_css_compiler, 'background_hover_color', 'background_hover_solid', 'background_hover_gradient' );
        ...
        // shadow
        $td_css_compiler->load_setting_raw( 'shadow_size', '16px' );
        $td_css_compiler->load_setting_raw( 'shadow_color', 'rgba(0, 0, 0, 0.1)');
        $td_css_compiler->load_setting_raw( 'shadow_offset_horizontal', 0);
        $td_css_compiler->load_setting_raw( 'shadow_offset_vertical', '2px');

        $td_css_compiler->load_setting_raw( 'shadow_hover_size', '26px' );
        $td_css_compiler->load_setting_raw( 'shadow_hover_color', 'rgba(0, 0, 0, 0.1)');
        $td_css_compiler->load_setting_raw( 'shadow_hover_offset_horizontal', 0);
        $td_css_compiler->load_setting_raw( 'shadow_hover_offset_vertical', '2px');

        // shadow variables
        $shadow_size = $this->get_style_att( 'shadow_size' );
        $shadow_color_style = $this->get_style_att( 'shadow_color' );
        ...
        $shadow_hover_color_style = $this->get_style_att( 'shadow_hover_color' );
        ...
        if ( !empty( $shadow_color_style ) ) {
            $td_css_compiler->load_setting_raw( 'shadow_color', $shadow_color_style );
        }
        ...
        if ( !empty( $shadow_hover_color_style ) ) {
            $td_css_compiler->load_setting_raw( 'shadow_hover_color', $shadow_hover_color_style );
        }
