...
class tds_button6 extends tds_api {
    ...
    private function get_css() {
        ...
        // style atts
        $td_css_compiler->load_setting_raw( 'border_size', '1px' );
        ...
        // shadow
        $td_css_compiler->load_setting_raw( 'shadow_offset', $this->get_style_att( 'shadow_offset' ) . 'px' );
        $td_css_compiler->load_setting_raw( 'shadow_hover_offset', $this->get_style_att( 'shadow_hover_offset' ) . 'px' );
        $td_css_compiler->load_setting_raw( 'shadow_color', $this->get_style_att( 'shadow_color' ) );
        $td_css_compiler->load_setting_raw( 'shadow_hover_color', $this->get_style_att( 'shadow_hover_color' ) );
