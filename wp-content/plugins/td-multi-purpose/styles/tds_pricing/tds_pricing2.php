...
class tds_pricing2 extends tds_api {
    ...
    private function get_css() {
        ...
        td_block::load_color_settings( $this, $td_css_compiler, 'header_color', 'header_color', 'header_color_gradient' );

        // header featured background color
        td_block::load_color_settings( $this, $td_css_compiler, 'header_featured_color', 'header_featured_color', 'header_featured_color_gradient' );
