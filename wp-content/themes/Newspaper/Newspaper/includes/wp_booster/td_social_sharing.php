...
//            }
        ...
        if (!empty($services)) {
            ...
            $buffy .= '<div id="' . $block_uid . '" class="td-post-sharing ' . $config_classes . ' td-post-sharing-' . $atts['style'] . $atts['el_class'] . ' " style="z-index: 2">';
                ...
                $buffy .= '<div class="td-post-sharing-visible">';
                    ...
                    foreach ($services as $service_id) {
                        ...
                        $buffy .= '<a class="td-social-sharing-button td-social-sharing-button-js td-social-network td-social-' . $service_id . '" href="' . $service_info['url'] . '" onclick="">
                ...
                $buffy .= '<div class="td-social-sharing-hidden">';
                    // the dropdown list
                    $buffy .= '<ul class="td-pulldown-filter-list" style="margin: 0"></ul>';
    ...
    private static function get_service_share_info($service_id) {
        ...
        switch ( $service_id ) {
            ...
            case 'pinterest':
                ...
                return array(
                    'url' => 'https://pinterest.com/pin/create/button/?url=' . $page_permalink . '&amp;media=' . ( ! empty( $image[0] ) ? $image[0] : '' ) . '&description=' . $td_pinterest_share_description,
                    'title' => 'Pinterest'
                );
                break;
