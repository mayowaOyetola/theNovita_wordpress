...
class tds_icon_box4 extends tds_api {
    ...
    private function get_css() {
        ...
        $td_css_compiler->load_setting_raw( 'icon_box_line_thick', $this->get_style_att( 'icon_box_line_thick' ) );
        ...
        $td_css_compiler->load_setting_raw( 'icon_box_line_color', $this->get_style_att( 'icon_box_line_color' ) );
        $td_css_compiler->load_setting_raw( 'icon_box_hover_line_color', $this->get_style_att( 'icon_box_hover_line_color' ) );
        ...
        $line_thick = $this->get_style_att( 'icon_box_line_thick' );
        ...
        // line thickness
        if ( ( $line_thick ) != '' && is_numeric( $line_thick ) ) {
            $td_css_compiler->load_setting_raw('icon_box_line_thick', $line_thick . 'px');
        }
